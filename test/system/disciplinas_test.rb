...
class DisciplinasTest < ApplicationSystemTestCase
  ...
  test "creating a Disciplina" do
    ...
    fill_in "Atividades", with: @disciplina.atividades
    fill_in "Nota", with: @disciplina.nota
    fill_in "Notasprovalivro", with: @disciplina.notasProvaLivro
    fill_in "Notastrabalho", with: @disciplina.notasTrabalho
    fill_in "Presenca", with: @disciplina.presenca
