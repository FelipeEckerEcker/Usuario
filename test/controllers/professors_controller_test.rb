...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { documento: @professor.documento, email: @professor.email, endereco: @professor.endereco, nome: @professor.nome, telefone: @professor.telefone } }
    end
